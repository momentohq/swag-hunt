...
import type {SwagList, SwagSummary } from '../utils/types'
import { useLastViewedPhoto } from '../utils/useLastViewedPhoto'

const Home: NextPage = ({ images }: { images: SwagSummary[] }) => {
    ...
    <>
      ...
      <main className="mx-auto max-w-[1960px] p-4">
        {photoId && (
          ...
          <SubmitForm onClose={() => {setShowAddSwag(false)}}/>
...
export async function getStaticProps() {
  const response = await fetch(`${process.env.NEXT_PUBLIC_BASE_URL}/swag`);
  const data : SwagList = await response.json();
