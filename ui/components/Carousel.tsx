...
export default function Carousel({ swag, admin }: { swag: SwagDetail, admin?: string }) {
  ...
  return (
    <div className="fixed inset-0 flex flex-col items-center pt-4 lg:justify-center lg:pt-0 px-4">
      <button
        className="absolute inset-0 z-30 cursor-default bg-momento-forest-green opacity-80 backdrop-blur-2xl text-white"
        onClick={closeModal}
      />
      <div className="flex flex-row z-50 items-center justify-center p-4 w-full bg-white rounded shadow-lg">
